        ...
        <main>
            <header className="text-gray-600 body-font">
                <div className="container flex flex-col flex-wrap items-center justify-between p-5 mx-auto md:flex-row">
                    <a className="flex items-center mb-4 font-medium text-gray-900 title-font md:mb-0">
                        <img src="/wix.png" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-10 h-10 p-1 text-white" viewBox="0 0 24 24" />
            ...
            <div className="container flex flex-col items-center px-5 py-10 mx-auto md:flex-row">
                ...
                <div className="flex items-center flex-shrink-0 mx-auto space-x-4 md:ml-auto md:mr-0">
                    ...
                    <a className="inline-flex items-center px-5 py-3 leading-6 bg-indigo-500 rounded-full hover:bg-indigo-300 focus:outline-none">
                        ...
                        <span className="items-start ml-2">
                            <span className="mb-1 text-xs text-white">Templates</span>
                        </span>
                    </a>
                </div>
            </div>
